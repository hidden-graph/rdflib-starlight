...
def run_oxigraph(triples, pred_bound):
    ...
    g = StarlightGraph(store=store, identifier=GRAPH_URI, backend='rdf-1.2')
    _run_queries(g, pred_bound, named_graph=False)
...
if __name__ == '__main__':
    ...
    print('StarlightGraph — scaling benchmark: in-memory / rdf-1.1 & rdf-1.2 Fuseki / rdf-1.2 Oxigraph')
