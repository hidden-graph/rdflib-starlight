"""Unit tests for starlight.query.remote_decompose - the mechanism that lets
a query depending on starlight's own custom SPARQL functions (TT_HASH_FN,
...
scoping the removal of starlight's old text-based SPARQL 1.2 rewriter: the
new sparql1_2_to_rdf-based pipeline can lower a non-ground triple-term
...
from starlight.query.remote_decompose import (
...
def test_stripped_filter_recipe_correctly_excludes_non_matching_rows():
    """End-to-end simulation of what StarlightGraph.query() does with the
    ...
    from starlight.model.encoding import tt_hash, term_key, remember_tt_hash, TT_NS
