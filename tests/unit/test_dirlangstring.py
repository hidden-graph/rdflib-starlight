...
Covers the DirLangString value type, StarlightGraph read/write interception,
...
from starlight.model.encoding import DIRLANG_NS, encode_dirlang_datatype, decode_dirlang_datatype
...
# ---------------------------------------------------------------------------
# StarlightGraph read/write
# ---------------------------------------------------------------------------

class TestStarlightGraphIntegration:
...
class TestNativeBackend:
    ...
    def test_parse_json_term_with_its_dir_key(self):
        ...
        from starlight.backends.native import _parse_json_term
