"""Confirms starlight/__init__.py's import-time patches for two confirmed
plain-rdflib SPARQL arithmetic bugs actually take effect against real
Graph().query() calls - see starlight/query/operator_patches.py for the
root-cause writeups.
"""

import starlight  # noqa: F401  (import-time patch application under test)
