...
starlight.model.encoding. StarlightGraph encodes/decodes at its read/write
boundary so callers only ever see DirLangString or plain rdflib terms.
"""

from rdflib import Literal

from starlight.model.encoding import encode_dirlang_datatype, decode_dirlang_datatype
...
def decode_dirlangstring(literal) -> DirLangString | None:
    """Return a DirLangString if literal is a starlight dirlang-encoded Literal, else None."""
